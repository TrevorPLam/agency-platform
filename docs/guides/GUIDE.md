...
- **Free**: 20 editor seats, 250k API requests/mo, 1M CDN requests/mo, 2 datasets
...
export async function POST(request: Request) {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    meta { serviceId }, // Pass data through to your webhook handler
  });
