...
_Use these prompts as-is or adapt the bracketed placeholders. They keep the AI within stack rules (Port 6543, app_metadata, cn(), @source, tw-animate-css, CONCURRENTLY, public.tenant_id())._
