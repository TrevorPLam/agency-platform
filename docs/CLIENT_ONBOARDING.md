...
_This guide replaces ONBOARDING_CHECKLIST.md and DAY_CARE_TEMPLATE.md. Strategic decisions (folder model, template) are in docs/architecture/ARCHITECTURE.md._
