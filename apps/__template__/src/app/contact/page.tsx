...
export const metadata = {
  title: 'Contact',
  description: 'Get in touch with TEMPLATE_NAME.',
}
    ...
    <main className="bg-background-primary text-text-primary min-h-screen">
      <div className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <section className="border-border-primary mt-12 border-t pt-8">
          ...
          <p className="text-text-secondary">123 Main Street, Your City, ST 12345</p>
          <p className="text-text-secondary mt-1">(555) 000-0000</p>
        </section>
      </div>
    </main>
  )
