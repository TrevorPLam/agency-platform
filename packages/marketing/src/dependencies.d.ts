...
declare module '@agency/analytics/client' {
...
declare module '@agency/analytics/consent-context' {
  import type { ReactNode } from 'react'
...
declare module '@agency/analytics/consent-banner' {
  import type { ReactNode } from 'react'

  export function SimpleConsentBanner(props?: { className?: string }): ReactNode
}
...
declare module '@agency/monitoring/client' {
  export interface PerformanceBudget {
    tenantId: string
    name: string
    category: 'lcp' | 'inp' | 'cls' | 'fcp' | 'ttfb' | 'bundle-size' | 'image-size'
